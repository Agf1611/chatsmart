...
<div class=" file-uploader">
   ...
   <div class="chose-area"></div>
                ...
                <span class="text-danger">example Button link : <span class="badge badge-secondary">url|Visit me|https://example.com</span> <br> example Call button : <span class="badge badge-secondary">call|Call me|6281234567891</span>  <br> The type only have two options, call and url!</span>
<br>
                                                 <button type="submit" name="sendMsg" class="btn btn-success mt-3"><i class="material-icons-outlined">send</i>Send</button>
                                             </form>
                                         </div>
